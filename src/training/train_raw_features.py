#!/usr/bin/env python3
"""
Train single-point models using raw features (45 features).

This script is a wrapper around train_single_point_models.py that automatically
uses the raw feature method (45 features: flattened [samples, 15, 3] -> [samples, 45]).

Usage:
    python3 src/training/train_raw_features.py --data-dir data/Single_Point/force_0.0to3.0N_step0.1N_single_test50/cleaned
    python3 src/training/train_raw_features.py --data-dir data/Single_Point/force_0.0to3.0N_step0.1N_single_test50 --cleaned
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train single-point models using raw features (45 features)"
    )
    parser.add_argument(
        '--data-dir',
        type=Path,
    ...
    print("="*80)
    print("TRAINING SINGLE-POINT MODELS - RAW FEATURES (45 features)")
    print("="*80)
    print(f"Data directory: {data_dir}")
    print(f"Feature method: raw (45 features)")
