...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lcccccc@{}}
        ...
        \midrule
        stretch\_000pct & 10152 & 0.2434 & 0.2353 & N/A & N/A & FAIL \\
        stretch\_010pct & 7508 & 0.2164 & 0.2137 & N/A & N/A & FAIL \\
        stretch\_020pct & 7955 & 0.2601 & 0.2489 & N/A & N/A & FAIL \\
        combined (pooled) & 25615 & 0.3250 & 0.2711 & N/A & N/A & FAIL \\
        \bottomrule
    \end{tabular}
    \vspace{0.1cm}
    \footnotesize
    \textit{Note: Sample counts represent the test set size after a 70/30 train/test split by sequence. Force range in data: [0.0, 3.0]~N (normalized).}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lcc@{}}
        ...
        \midrule
        stretch\_000pct & 10152 & 1.000 \\
        stretch\_010pct & 7508 & 1.000 \\
        stretch\_020pct & 7955 & 1.000 \\
        combined (pooled) & 25615 & 1.000 \\
        \bottomrule
    \end{tabular}
    \vspace{0.1cm}
    \footnotesize
    \textit{Note: Sample counts represent the test set size after a 70/30 train/test split by sequence.}
\end{table}
...
\begin{table}[H]
    ...
    \vspace{0.1cm}
    \footnotesize
    \textit{Note: Sample count represents the test set size after a 70/30 train/test split by sequence.}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lccc@{}}
        ...
        \midrule
        stretch\_000pct & 11130 & $9.17 \times 10^{-15}$ & $9.16 \times 10^{-15}$ \\
        stretch\_010pct & 11130 & $9.21 \times 10^{-15}$ & $9.21 \times 10^{-15}$ \\
        stretch\_020pct & 11130 & $9.25 \times 10^{-15}$ & $9.25 \times 10^{-15}$ \\
        combined (pooled) & 33390 & $5.18 \times 10^{-4}$ & $5.18 \times 10^{-4}$ \\
        \bottomrule
    \end{tabular}
    \vspace{0.1cm}
    \footnotesize
    \textit{Note: Per-stretch models achieve near-perfect accuracy due to deterministic simulation. The combined model shows slightly higher RMSE due to increased diversity across stretch levels.}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lcc@{}}
        ...
        \midrule
        stretch\_000pct position classifier & 11130 & 1.000 \\
        stretch\_010pct position classifier & 11130 & 1.000 \\
        stretch\_020pct position classifier & 11130 & 1.000 \\
        combined position classifier & 33390 & 1.000 \\
        combined stretch classifier & 33390 & 1.000 \\
        \bottomrule
    \end{tabular}
    \vspace{0.1cm}
    \footnotesize
    \textit{Note: Offset mapping uses relative positions to center, enabling correct classification across different stretch levels despite varying absolute coordinates.}
\end{table}
