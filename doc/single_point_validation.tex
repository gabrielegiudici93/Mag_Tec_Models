...
\begin{table}[H]
    ...
    \begin{tabular}{@{}p{6.0cm}p{8.0cm}@{}}
        ...
        Movement between offsets & Robot lifts \SI{5}{\milli\metre} before moving horizontally, then lowers \SI{5}{\milli\metre} at target position to avoid sliding on surface. \\
